...
tags: broker, consumer, event driven arcitecture, event-processing, producer, pub/sub, stream-processing, event-driven-architecture
...
<img
  ...
  loading="eager"
  src="/blog/event-driven-architecture/event-driven-architecture.png"
  height="630"
  width="1200"
/>
<div align="center">Figure: Event-Driven Architecture</div>
