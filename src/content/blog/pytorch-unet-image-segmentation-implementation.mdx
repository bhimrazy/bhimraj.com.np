...
[3] PyTorchUNet. *GitHub*. [PyTorchUNet : A PyTorch Implementation of UNet Architecture for Semantic Segmentation of Images from scratch.](https://github.com/bhimrazy/unet)