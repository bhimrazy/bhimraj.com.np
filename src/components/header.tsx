...
export default function Header() {
    ...
    return (
        <header className="flex bg-white sticky top-0 w-full place-content-center border-b">
            <nav className="flex justify-between px-4 py-4 xl:px-0 w-full max-w-5xl mx-auto items-center">
                <ul className="flex space-x-2 sm:space-x-4 md:space-x-5 lg:space-x-6 font-medium text-gray-700">
