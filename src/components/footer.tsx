    ...
    <footer className="flex border-t dark:border-gray-800">
      <div className="mx-auto flex w-full max-w-5xl flex-col px-4 xl:px-0">
        <section className="py-10 md:py-12">
          <nav>
            <ul className="flex justify-center space-x-4 font-medium text-gray-700 text-sm md:text-base">
              {footer_navs.map((item, _idx) => (
        ...
        <section className="flex flex-col space-y-2 pb-8">
          <span className="text-center font-medium text-base text-gray-600 sm:text-lg">
            {social_contact?.title}
          </span>
          <ul className="flex justify-center space-x-4">
            {social_contact?.social_media.map((item, _idx) => (
              <li
                key={item.title}
                className="transition-all hover:opacity-95 hover:drop-shadow-xs"
              >
        ...
        <section className="flex items-center justify-center divide-x border-t py-10 text-gray-500 dark:border-gray-900">
          <small className="pr-3 font-medium text-sm tracking-wide">
            {copyright}
          </small>
          <small className="cursor-pointer pl-3 font-medium text-sm tracking-wide hover:text-gray-800">
            {policy}
          </small>
        </section>
      </div>
