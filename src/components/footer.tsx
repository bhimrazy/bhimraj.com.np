export default function Footer() {
    const footer_navs = [
        "Docs", "Book Notes", "Polywork", "Guestbook", "Statistics"
    ]
    ...
    return (
        <footer className="flex border-t">
            <div className="flex flex-col px-4 py-2 space-y-4 xl:px-0 w-full max-w-5xl mx-auto">
                ...
                <section className="flex flex-col space-y-1 py-2">
                    <span className="text-center text-sm font-medium text-gray-600">{social_contact?.title}</span>
