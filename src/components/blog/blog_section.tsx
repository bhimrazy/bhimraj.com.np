          ...
          <article key={idx}>
            <div className="grid grid-cols-1 md:grid-cols-6">
              ...
              <div className="md:col-span-5">
                ...
                <Link className="group inline-flex h-9 items-center whitespace-nowrap rounded-full bg-slate-100 px-3 text-sm font-semibold text-slate-700 hover:bg-slate-200 hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-500 dark:bg-slate-700 dark:text-slate-100 dark:hover:bg-slate-600 dark:hover:text-white dark:focus:ring-slate-500" href="/blog/[slug]/" as={`/blog/${blog.slug}/`}>
